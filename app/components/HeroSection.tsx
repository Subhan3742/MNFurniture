...
const slides = [
  {
    ...
    subtitle: "Premium Sofas & Living Room Furniture",
    btn: "Shop Now",
    link: "#categories",
  },
  {
    ...
    subtitle: "Timeless elegance for your personal space",
    btn: "Explore Bedroom",
    link: "#categories",
  },
  {
...
export default function HeroSection() {
  ...
  return (
    <>
        ...
        <div className="relative z-10 h-full flex items-center px-8 md:px-20">
          <AnimatePresence mode="wait">
            <motion.div
              ...
              className="max-w-xl"
            >
              <p className="text-white/60 uppercase tracking-[0.3em] text-sm mb-4">
                MNFurniture.online
              </p>
              ...
              <div className="flex gap-4">
                <Link
                  ...
                  className="px-5 py-2 bg-amber-700 text-white font-semibold uppercase tracking-wider text-xs hover:bg-amber-800 transition-all"
                >
                  {slides[current].btn}
                </Link>
                <Link
                  href="#contact"
                  className="px-5 py-2 border border-white text-white font-semibold uppercase tracking-wider text-xs hover:bg-white/10 transition-all"
                >
                  Contact Us
                </Link>
              </div>
      ...
      {/* Features Bar */}
      <div className="bg-stone-900 text-white py-5 px-4">
        <div className="max-w-7xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-6">
          {[
            { icon: "🚚", title: "Free Delivery", sub: "On orders over PKR 10,000" },
            { icon: "🔨", title: "Custom Made", sub: "Tailored to your needs" },
            { icon: "🛡️", title: "5 Year Warranty", sub: "Quality guaranteed" },
            { icon: "📞", title: "24/7 Support", sub: "Call: 0300-1234567" },
          ].map((f) => (
